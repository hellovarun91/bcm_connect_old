...
/**
 * MediumHorizontalFrame component for displaying content in a horizontal styled container
 * Uses the HUD-4 health new 2026.gif as background
 * 
 * @param {Object} props - Component props
 * @param {string} [props.typographyPreset] - Optional preset for consistent typography ('small', 'medium', 'large')
 */
const MediumHorizontalFrame = ({
  ...
  return (
    ...
    >
      {/* Background Frame GIF */}
      <SinglePlayGif
        src={mediumHorizontalFrameIcon}
        alt="frame"
        duration={2500}
        style={{
          position: "absolute",
...
export default MediumHorizontalFrame;

MediumHorizontalFrame.propTypes = {
